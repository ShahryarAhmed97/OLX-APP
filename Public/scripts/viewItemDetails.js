...
var recieverName=localStorage.getItem('recieverUserName');
 ...
 var allKeys=localStorage.getItem('keysObj');
  ...
  function sendFun(){
    ...
    // firebase.database().ref("fcmTokens").on("value", function(snapshot) {
    //   recieverId=localStorage.getItem('recieverId');
    ...
    //       if (values[i] == recieverId) {
    //           //Getting the token of the reciever using  if condition..!
    //           console.log(keys[i]);
    ...
    //               headers: {
    //                   Authorization: "key=" + "AIzaSyCS3ms-xkeN4PL_3G4ak9mxQHUuS2gsJhk"
    //                 },
...
//           if (token.val() == recieverId.value) { //Getting the token of the reciever using  if condition..!   
//               // console.log(token.key)   
//               $.ajax({
//                   type: 'POST',
//                   url: "https://fcm.googleapis.com/fcm/send",
//                   headers: { Authorization: 'key=' + 'AIzaSyCS3ms-xkeN4PL_3G4ak9mxQHUuS2gsJhk' },
//                   contentType: 'application/json',
//                   dataType: 'json',
//                   data: JSON.stringify({
//                       "to": token.key,
