...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', function() {
      navigator.serviceWorker.register('../sw_olx.js').then(function(registration) {
...
var userGreet=document.getElementById('userGreet')
  

  if(userUid==null || userUid.toString()=="null" ){
            ...
            if(search.toLowerCase()=== (allItemsObj[key][key2][key3].itemName).toLowerCase()){
              ...
              <div class="col-xs-12 col-sm-6 col-md-3">
                    <article class="card-wrapper">
                      <div class="image-holder">
                        <a href="javascript:void(0)" onclick='wishListFun("${key}","${key2}","${key3}")' class="image-holder__link"> </a>
                        <div class="image-liquid image-holder--original" style="background-image: url('${allItemsObj[key][key2][key3].itemImg}')">
                        </div>
                      </div>
                      ...
                      <div class="product-description">
                        ...
                        <h1 class="product-description__title">
                          <a href="#">						
                          "${allItemsObj[key][key2][key3].itemName}"
                            </a>
                        </h1>
                        ...
                        <div class="row">
                          <div class="col-xs-12 col-sm-8 product-description__category secondary-text">
                          "${allItemsObj[key][key2][key3].itemDesc}"
                          </div>
                          <div class="col-xs-12 col-sm-4 product-description__price">
                          "${allItemsObj[key][key2][key3].itemPrice}"
                          </div>
                        </div>
